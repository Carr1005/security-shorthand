...
## 前言
因為需要準備一套會員機制的模組，必須面對像是密碼、Cookie的保存問題，基於職業道德，想研究一下要怎麼implement才是比較安全的做法，文章是我在看完一大堆相關文章後歸納的心得，釐清實作上一些措施的因果關係，避免產出不知所以然的程式碼。一些名詞解釋目前先不打算寫上來，因為reference的連結裡都寫得很好了。對這領域沒有深耕，也只是歸納一些不負責心得，歡迎大大狠狠的甩臉指正.
